...
[GitHub Sourcecode](https://github.com/cisagov/RedEye)

### Details
- **Role** - UX Design & Frontend Engineering 
- **Team** - 6 Contributors 
- **Timeline** - 1 Year (30% weekly for 3 years) 2020-2023 
- **Client** - US CyberSecurity and Infrastructure Security Agency (CISA)
...
![Log Files](public/lfs-media/RedEye/Cobalt-Strike-Log-Files.png)
...
<Layouts.Columns count={2}>![](public/lfs-media/RedEye/High-Fi-05.png) ![](public/lfs-media/RedEye/High-Fi-05.png) </Layouts.Columns>

<Layouts.Columns count={4}>![](public/lfs-media/RedEye/High-Fi-05.png) ![](public/lfs-media/RedEye/Cobalt-Strike-Log-Files.png) ![](public/lfs-media/RedEye/High-Fi-05.png)  ![](public/lfs-media/RedEye/High-Fi-05.png)</Layouts.Columns>

<Layouts.Columns count={3}>![](public/lfs-media/RedEye/High-Fi-05.png) ![](public/lfs-media/RedEye/High-Fi-05.png) ![](public/lfs-media/RedEye/High-Fi-05.png) </Layouts.Columns>

<Layouts.Columns count={2}>![](public/lfs-media/RedEye/High-Fi-05.png) ![](public/lfs-media/RedEye/High-Fi-05.png) ![](public/lfs-media/RedEye/High-Fi-05.png)  ![](public/lfs-media/RedEye/High-Fi-05.png)</Layouts.Columns>
...
![](public/lfs-media/RedEye/High-Fi-03.png)
...
![](public/lfs-media/RedEye/Placeholder.png)
