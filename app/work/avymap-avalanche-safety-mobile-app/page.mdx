...
<PageHeader {...{
  ...
  heroImageProps: {
    src: "/lfs-media/avymap-avalanche-safety-mobile-app/AvyMap_header-2.png",
    alt: "AvyMap: Avalanche Safety Mobile App"
  }
}} />
...
<p style={{textAlign:'center'}}>
    <video src="/lfs-media/avymap-avalanche-safety-mobile-app/AvyMaps-App-Movie-3.mp4" />
</p>
...
<Layouts.Image imageProps={{ src: Src.public_lfsmedia_avymapavalanchesafetymobileapp_AvyMapprototypelowqualgif, sizes: imgSizes.column1Max, alt: "" }} />
</Layouts.Columns>
</Layouts.ColumnMax>
...
<Layouts.ColumnMax>
<Layouts.Columns count={1}>
<Layouts.Image imageProps={{ src: Src.public_lfsmedia_avymapavalanchesafetymobileapp_AvyMapLogosvg, sizes: imgSizes.column1Max, alt: "" }} />
</Layouts.Columns>

<Layouts.Columns count={5} equalHeight>
<Layouts.Image imageProps={{ src: Src.public_lfsmedia_avymapavalanchesafetymobileapp_AvyMapLogoDanger0png, sizes: imgSizes.column5Max, alt: "" }} />
<Layouts.Image imageProps={{ src: Src.public_lfsmedia_avymapavalanchesafetymobileapp_AvyMapLogoDanger1png, sizes: imgSizes.column5Max, alt: "" }} />
<Layouts.Image imageProps={{ src: Src.public_lfsmedia_avymapavalanchesafetymobileapp_AvyMapLogoDanger2png, sizes: imgSizes.column5Max, alt: "" }} />
<Layouts.Image imageProps={{ src: Src.public_lfsmedia_avymapavalanchesafetymobileapp_AvyMapLogoDanger3png, sizes: imgSizes.column5Max, alt: "" }} />
<Layouts.Image imageProps={{ src: Src.public_lfsmedia_avymapavalanchesafetymobileapp_AvyMapLogoDanger4png, sizes: imgSizes.column5Max, alt: "" }} />
</Layouts.Columns>
</Layouts.ColumnMax>
...
<Layouts.ColumnMax>
<Layouts.Columns count={1}>
<Layouts.Image imageProps={{ src: Src.public_lfsmedia_avymapavalanchesafetymobileapp_AvyMapLogoVectorspng, sizes: imgSizes.column1Max, alt: "" }} />
</Layouts.Columns>
</Layouts.ColumnMax>
