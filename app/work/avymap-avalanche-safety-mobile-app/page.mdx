...
<Layouts.Image imageProps={{ src: Src.public_lfsmedia_avymapavalanchesafetymobileapp_AvyMapprototypelowqualgif, sizes: imgSizes.column1Full, alt: "" }} />
...
<Layouts.Image imageProps={{ src: Src.public_lfsmedia_avymapavalanchesafetymobileapp_AvyMapLogosvg, sizes: imgSizes.column1Full, alt: "" }} />

<Layouts.Columns count={4}>
<Layouts.Image imageProps={{ src: Src.public_lfsmedia_avymapavalanchesafetymobileapp_AvyMapLogoDanger0png, sizes: imgSizes.column4Max, alt: "" }} />

<Layouts.Image imageProps={{ src: Src.public_lfsmedia_avymapavalanchesafetymobileapp_AvyMapLogoDanger1png, sizes: imgSizes.column4Max, alt: "" }} />

<Layouts.Image imageProps={{ src: Src.public_lfsmedia_avymapavalanchesafetymobileapp_AvyMapLogoDanger2png, sizes: imgSizes.column4Max, alt: "" }} />

<Layouts.Image imageProps={{ src: Src.public_lfsmedia_avymapavalanchesafetymobileapp_AvyMapLogoDanger3png, sizes: imgSizes.column4Max, alt: "" }} />

<Layouts.Image imageProps={{ src: Src.public_lfsmedia_avymapavalanchesafetymobileapp_AvyMapLogoDanger4png, sizes: imgSizes.column4Max, alt: "" }} />
</Layouts.Columns>

It's pixel aligned down to a 32px width, so it's always super crisp at any multiple of 32px.

<Layouts.Image imageProps={{ src: Src.public_lfsmedia_avymapavalanchesafetymobileapp_AvyMapLogoVectorspng, sizes: imgSizes.column1Full, alt: "" }} />
